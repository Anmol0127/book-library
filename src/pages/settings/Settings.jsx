...
const Settings = () => {
  ...
  const [name,  privateStatus] = useUserData();
      ...
      <div className="bg-gray-200 dark:bg-gray-800 col-start-2 col-span-2 p-6 rounded-lg m-3 md:my-6">
        ...
        <div className="mt-3">
          ...
          <Link to="/" onClick={signOutUser}>
            <button className="mt-2 px-6 py-2 tracking-wide text-white transition-colors duration-300 transform bg-red-600 rounded-lg hover:bg-red-500 focus:outline-none focus:ring focus:ring-red-300 focus:ring-opacity-80 flex items-center gap-2">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
